...
<script type="text/javascript">
  ...
  ga('create', 'UA-52313725-1', 'auto', { 'name': 'ecpeTracker', 'allowLinker': true }); 
  ga('ecpeTracker.require', 'linker'); 
  ga('ecpeTracker.linker:autoLink', ['sph.harvard.edu']); 
  ga('ecpeTracker.require', 'displayfeatures'); 
  ga('ecpeTracker.require', 'linkid', 'linkid.js'); 
  ga('ecpeTracker.send', 'pageview');
</script>
</head>
...
<script type="text/javascript">
  (function(d,s,i,r) {
    ...
    n.id=i;n.src='//js.hs-analytics.net/analytics/'+(Math.ceil(new Date()/r)*r)+'/521123.js';
